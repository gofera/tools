<template>
  <span class="hamburger-wrapper">
    <svg t="1492500959545" @click="toggleSideBarAndHamLock" class="svg-icon hamburger" :class="{'is-active':sidebarLocked}" style=""
...
<script lang="ts">
    ...
    export default class Hamburger extends Vue {
        ...
        @Action(Cmd.TOGGLE_HAM_LOCK) private toggleHamLock !: () => void;

        protected toggleSideBarAndHamLock(): void {
            this.toggleSidebar();
            this.toggleHamLock();
        }
    }
